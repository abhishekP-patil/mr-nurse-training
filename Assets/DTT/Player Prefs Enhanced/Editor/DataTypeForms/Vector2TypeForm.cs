...
{
    /// <summary>
    /// Class used to draw the CRUD content for a <see cref="Vector2"/> datatype.
    /// </summary>
    internal class Vector2TypeForm : AbstractTypeForm<Vector2>
    {
        /// <summary>
        ...
        public override void DrawUpdateFields()
        {
            EditorGUILayout.BeginHorizontal();
            EditorGUILayout.LabelField("Value:", EditorStyles.boldLabel, GUILayout.Width(p_labelWidth), GUILayout.Height(p_labelHeight));
            p_value = EditorGUILayout.Vector2Field("", p_value, GUILayout.Height(p_labelHeight));
            EditorGUILayout.EndHorizontal();
        }
