...
{
    /// <summary>
    /// Class used to draw the CRUD content for a <see cref="string"/> datatype.
    /// </summary>
    internal class StringTypeForm : AbstractTypeForm<string>
    {
        /// <summary>
        ...
        public override void DrawUpdateFields()
        {
            EditorGUILayout.BeginHorizontal();
            EditorGUILayout.LabelField("Value:", EditorStyles.boldLabel, GUILayout.Width(p_labelWidth), GUILayout.Height(p_labelHeight));
            p_value = EditorGUILayout.TextArea(p_value);
            EditorGUILayout.EndHorizontal();
        }
