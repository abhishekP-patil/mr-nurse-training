...
{
    /// <summary>
    /// Class used to draw the CRUD content for a <see cref="long"/> datatype.
    /// </summary>
    internal class LongTypeForm : AbstractTypeForm<long>
    {
        /// <summary>
        ...
        public override void DrawUpdateFields()
        {
            EditorGUILayout.BeginHorizontal();
            EditorGUILayout.LabelField("Value:", EditorStyles.boldLabel, GUILayout.Width(p_labelWidth), GUILayout.Height(p_labelHeight));
            p_value = EditorGUILayout.LongField(p_value);
            EditorGUILayout.EndHorizontal();
        }
