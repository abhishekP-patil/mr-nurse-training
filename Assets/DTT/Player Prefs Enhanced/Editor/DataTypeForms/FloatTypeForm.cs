...
{
    /// <summary>
    /// Class used to draw the CRUD content for a <see cref="float"/> datatype.
    /// </summary>
    internal class FloatTypeForm : AbstractTypeForm<float>
    {
        /// <summary>
        ...
        public override void DrawUpdateFields()
        {
            EditorGUILayout.BeginHorizontal();
            EditorGUILayout.LabelField("Value:", EditorStyles.boldLabel, GUILayout.Width(p_labelWidth), GUILayout.Height(p_labelHeight));
            p_value = EditorGUILayout.FloatField(p_value);
            EditorGUILayout.EndHorizontal();
        }
